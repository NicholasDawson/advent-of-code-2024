...
# scan with a window of 5 characters through input to find
# potential commandes
do = True
for x in range(len(puzzle_input)-1-8):
    if puzzle_input[x:x+4] == 'do()':
        do = True
    elif puzzle_input[x:x+7] == 'don\'t()':
        do = False
    elif puzzle_input[x:x+4] == 'mul(' and do:
